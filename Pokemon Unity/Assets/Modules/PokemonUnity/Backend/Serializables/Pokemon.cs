...
/// Purpose: Pokémon serializable data for Pokémon Unity backend
...
public class Pokemon
{
    ...
    //
    // This isn't used in legacy so I will be commenting out for now.
    //
        ...
        string nature, int ability, string[] moveset, int[] PPups)
    {
        ...
        this.metLevel = level;
        // TODO: Find a way to do this without using frontend
        this.metMap = "Somewhere";
        /*if (Player.player != null)
        {
            if (Player.player.accessedMapSettings != null)
            {
                this.metMap = Player.player.accessedMapSettings.mapName;
            }
        }*/
    ...
    public bool checkEvolutionMethods(string currentMethod, string evolutionRequirements)
    {
        ...
        for (int i = 0; i < methods.Length; i++)
        {
            ...
            else if (methods[i] == "Map")
            {
                ...
                // TODO: Player scripts
                string mapName = "Somewhere";
                //string mapName = Player.player.currentMap.name;
